<div class="flex flex-row justify-between  items-center bg-white relative lg:px-2 xl:px-8 pt-4">
    <img src="/images/speciality.png" class=" bg-gray-400 bg-opacity-10 w-52 px-3 py-2  rounded-full  " alt="craft_logo">
            ...
            <ul class="flex flex-col text-center gap-y-4 mt-8 mb-8">
                ...
                <li x-data="{open : false}" class="flex flex-col  justify-center ">
                    ...
                    <ul class=" p-6 flex flex-col gap-2 ltr:text-left rtl:text-right    ">
                        ...
                        <li><a href="{{route('departments.guest.show', ['locale' => app()->currentLocale(), 'slug' => '24x7-cardiac-care'])}}"
